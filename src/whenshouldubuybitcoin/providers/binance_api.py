...
def fetch_btc_funding_rate() -> Optional[float]:
    """
    Fetch the current funding rate for BTCUSDT perpetual contract.
...
def fetch_open_interest_history(symbol: str = "BTCUSDT", period: str = "1d", limit: int = 500) -> Optional[list]:
    """
